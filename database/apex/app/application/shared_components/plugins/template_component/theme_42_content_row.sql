...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(66187692927352130)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1993425431742423828)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1993424876730423827)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66188355198352133)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66188665715352134)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66188918586352134)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66189211874352134)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66189585605352134)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66189889041352134)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66190141234352135)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(66189585605352134)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1993425431742423828)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66190451922352135)
,p_plugin_attribute_id=>wwv_flow_imp.id(66190141234352135)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66190865077352135)
,p_plugin_attribute_id=>wwv_flow_imp.id(66190141234352135)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66191275671352135)
,p_plugin_attribute_id=>wwv_flow_imp.id(66190141234352135)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66191695964352135)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(66190141234352135)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66191930167352136)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(66191695964352135)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66192290507352136)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66192543568352136)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66192810305352136)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66193167900352137)
,p_plugin_attribute_id=>wwv_flow_imp.id(66192810305352136)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66193516890352137)
,p_plugin_attribute_id=>wwv_flow_imp.id(66192810305352136)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66193973842352137)
,p_plugin_attribute_id=>wwv_flow_imp.id(66192810305352136)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66194310359352137)
,p_plugin_attribute_id=>wwv_flow_imp.id(66192810305352136)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66194743235352137)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(66189889041352134)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1993424876730423827)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66195085627352137)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66195327500352138)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66195682077352138)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66195927938352138)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66196288426352138)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66196521667352138)
,p_plugin_attribute_id=>wwv_flow_imp.id(66196288426352138)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66196979370352138)
,p_plugin_attribute_id=>wwv_flow_imp.id(66196288426352138)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66197349810352139)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66197633292352139)
,p_plugin_attribute_id=>wwv_flow_imp.id(66197349810352139)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66198085690352139)
,p_plugin_attribute_id=>wwv_flow_imp.id(66197349810352139)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66198486893352139)
,p_plugin_attribute_id=>wwv_flow_imp.id(66197349810352139)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66198826515352139)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66199136015352139)
,p_plugin_attribute_id=>wwv_flow_imp.id(66198826515352139)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66199585823352140)
,p_plugin_attribute_id=>wwv_flow_imp.id(66198826515352139)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66199915463352140)
,p_plugin_attribute_id=>wwv_flow_imp.id(66198826515352139)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66200344038352140)
,p_plugin_attribute_id=>wwv_flow_imp.id(66198826515352139)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66200799100352140)
,p_plugin_attribute_id=>wwv_flow_imp.id(66198826515352139)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66201132963352140)
,p_plugin_attribute_id=>wwv_flow_imp.id(66198826515352139)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66201544543352140)
,p_plugin_attribute_id=>wwv_flow_imp.id(66198826515352139)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66201908597352141)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66202222715352141)
,p_plugin_attribute_id=>wwv_flow_imp.id(66201908597352141)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66202698606352141)
,p_plugin_attribute_id=>wwv_flow_imp.id(66201908597352141)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66203092673352141)
,p_plugin_attribute_id=>wwv_flow_imp.id(66201908597352141)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66203442925352141)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66203783630352142)
,p_plugin_attribute_id=>wwv_flow_imp.id(66203442925352141)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66204201555352142)
,p_plugin_attribute_id=>wwv_flow_imp.id(66203442925352141)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66204571850352142)
,p_plugin_attribute_id=>wwv_flow_imp.id(66203442925352141)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66204971705352142)
,p_plugin_attribute_id=>wwv_flow_imp.id(66203442925352141)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66205323220352142)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1874639321958245442)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1874640581478249590)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1861045693283838709)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1861724994013921813)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1874637386891200456)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1874638720281214313)
,p_plugin_id=>wwv_flow_imp.id(66187692927352130)
