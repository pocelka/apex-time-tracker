...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(66160149423352047)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66160448021352082)
,p_plugin_id=>wwv_flow_imp.id(66160149423352047)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66160795005352084)
,p_plugin_attribute_id=>wwv_flow_imp.id(66160448021352082)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66161164719352085)
,p_plugin_attribute_id=>wwv_flow_imp.id(66160448021352082)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66161579473352086)
,p_plugin_attribute_id=>wwv_flow_imp.id(66160448021352082)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66161917503352086)
,p_plugin_id=>wwv_flow_imp.id(66160149423352047)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(66160448021352082)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66162291340352087)
,p_plugin_id=>wwv_flow_imp.id(66160149423352047)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(66161917503352086)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66162573643352087)
,p_plugin_id=>wwv_flow_imp.id(66160149423352047)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66162811750352087)
,p_plugin_id=>wwv_flow_imp.id(66160149423352047)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66163193761352087)
,p_plugin_id=>wwv_flow_imp.id(66160149423352047)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66163470559352087)
,p_plugin_attribute_id=>wwv_flow_imp.id(66163193761352087)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66163817857352087)
,p_plugin_attribute_id=>wwv_flow_imp.id(66163193761352087)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66164297422352088)
,p_plugin_attribute_id=>wwv_flow_imp.id(66163193761352087)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66164670517352088)
,p_plugin_id=>wwv_flow_imp.id(66160149423352047)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66164938062352088)
,p_plugin_attribute_id=>wwv_flow_imp.id(66164670517352088)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66165326049352088)
,p_plugin_attribute_id=>wwv_flow_imp.id(66164670517352088)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66165773321352088)
,p_plugin_attribute_id=>wwv_flow_imp.id(66164670517352088)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66166124679352089)
,p_plugin_attribute_id=>wwv_flow_imp.id(66164670517352088)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66166588592352089)
,p_plugin_attribute_id=>wwv_flow_imp.id(66164670517352088)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66167003644352089)
,p_plugin_attribute_id=>wwv_flow_imp.id(66164670517352088)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66167372551352089)
,p_plugin_attribute_id=>wwv_flow_imp.id(66164670517352088)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66167788413352090)
,p_plugin_id=>wwv_flow_imp.id(66160149423352047)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1866211055462465799)
,p_plugin_id=>wwv_flow_imp.id(66160149423352047)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
