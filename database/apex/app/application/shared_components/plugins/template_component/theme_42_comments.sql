...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(66177674466352120)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1866063146502383836)
,p_plugin_id=>wwv_flow_imp.id(66177674466352120)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66178179733352122)
,p_plugin_id=>wwv_flow_imp.id(66177674466352120)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66178486924352122)
,p_plugin_id=>wwv_flow_imp.id(66177674466352120)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66178789334352122)
,p_plugin_id=>wwv_flow_imp.id(66177674466352120)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66179058069352122)
,p_plugin_id=>wwv_flow_imp.id(66177674466352120)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66179370275352122)
,p_plugin_id=>wwv_flow_imp.id(66177674466352120)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(66183984006352125)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1866063146502383836)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66179686705352122)
,p_plugin_attribute_id=>wwv_flow_imp.id(66179370275352122)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66180056949352123)
,p_plugin_attribute_id=>wwv_flow_imp.id(66179370275352122)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66180426559352123)
,p_plugin_attribute_id=>wwv_flow_imp.id(66179370275352122)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66180862820352123)
,p_plugin_id=>wwv_flow_imp.id(66177674466352120)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(66179370275352122)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66181153169352123)
,p_plugin_id=>wwv_flow_imp.id(66177674466352120)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(66180862820352123)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66181432980352123)
,p_plugin_id=>wwv_flow_imp.id(66177674466352120)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66181767680352124)
,p_plugin_id=>wwv_flow_imp.id(66177674466352120)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66182089530352124)
,p_plugin_id=>wwv_flow_imp.id(66177674466352120)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66182326540352124)
,p_plugin_attribute_id=>wwv_flow_imp.id(66182089530352124)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66182754887352124)
,p_plugin_attribute_id=>wwv_flow_imp.id(66182089530352124)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66183171517352124)
,p_plugin_attribute_id=>wwv_flow_imp.id(66182089530352124)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66183506725352124)
,p_plugin_attribute_id=>wwv_flow_imp.id(66182089530352124)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66183984006352125)
,p_plugin_id=>wwv_flow_imp.id(66177674466352120)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66184232820352125)
,p_plugin_id=>wwv_flow_imp.id(66177674466352120)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66184546725352125)
,p_plugin_attribute_id=>wwv_flow_imp.id(66184232820352125)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66184984423352125)
,p_plugin_attribute_id=>wwv_flow_imp.id(66184232820352125)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66185372471352125)
,p_plugin_id=>wwv_flow_imp.id(66177674466352120)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1866195813935485339)
,p_plugin_id=>wwv_flow_imp.id(66177674466352120)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1866195222430477882)
,p_plugin_id=>wwv_flow_imp.id(66177674466352120)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1866250846100459761)
,p_plugin_id=>wwv_flow_imp.id(66177674466352120)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1866403063813330532)
,p_plugin_id=>wwv_flow_imp.id(66177674466352120)
