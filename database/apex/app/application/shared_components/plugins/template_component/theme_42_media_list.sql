...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(66210075089352148)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1866227878995235796)
,p_plugin_id=>wwv_flow_imp.id(66210075089352148)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1866228434007235797)
,p_plugin_id=>wwv_flow_imp.id(66210075089352148)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66210721131352149)
,p_plugin_id=>wwv_flow_imp.id(66210075089352148)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66211088131352149)
,p_plugin_id=>wwv_flow_imp.id(66210075089352148)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66211356162352149)
,p_plugin_id=>wwv_flow_imp.id(66210075089352148)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66211656506352149)
,p_plugin_id=>wwv_flow_imp.id(66210075089352148)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66212003299352150)
,p_plugin_id=>wwv_flow_imp.id(66210075089352148)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(66211356162352149)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1866228434007235797)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66212244616352150)
,p_plugin_attribute_id=>wwv_flow_imp.id(66212003299352150)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66212613922352150)
,p_plugin_attribute_id=>wwv_flow_imp.id(66212003299352150)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66213033268352150)
,p_plugin_attribute_id=>wwv_flow_imp.id(66212003299352150)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66213469780352150)
,p_plugin_id=>wwv_flow_imp.id(66210075089352148)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(66212003299352150)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66213729820352150)
,p_plugin_id=>wwv_flow_imp.id(66210075089352148)
,p_attribute_scope=>'COMPONENT'
...
,p_depending_on_attribute_id=>wwv_flow_imp.id(66213469780352150)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66214097624352151)
,p_plugin_id=>wwv_flow_imp.id(66210075089352148)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66214329511352151)
,p_plugin_id=>wwv_flow_imp.id(66210075089352148)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66214658843352151)
,p_plugin_id=>wwv_flow_imp.id(66210075089352148)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66214982452352151)
,p_plugin_attribute_id=>wwv_flow_imp.id(66214658843352151)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66215338074352151)
,p_plugin_attribute_id=>wwv_flow_imp.id(66214658843352151)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66215716948352151)
,p_plugin_attribute_id=>wwv_flow_imp.id(66214658843352151)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66216193994352152)
,p_plugin_attribute_id=>wwv_flow_imp.id(66214658843352151)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66216549603352152)
,p_plugin_id=>wwv_flow_imp.id(66210075089352148)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(66211656506352149)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1866227878995235796)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66216854160352152)
,p_plugin_id=>wwv_flow_imp.id(66210075089352148)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66217146319352152)
,p_plugin_id=>wwv_flow_imp.id(66210075089352148)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66217427221352152)
,p_plugin_id=>wwv_flow_imp.id(66210075089352148)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66217758888352152)
,p_plugin_id=>wwv_flow_imp.id(66210075089352148)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66218059508352153)
,p_plugin_id=>wwv_flow_imp.id(66210075089352148)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66218396824352153)
,p_plugin_attribute_id=>wwv_flow_imp.id(66218059508352153)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66218730718352153)
,p_plugin_attribute_id=>wwv_flow_imp.id(66218059508352153)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66219133941352153)
,p_plugin_id=>wwv_flow_imp.id(66210075089352148)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66219407897352153)
,p_plugin_attribute_id=>wwv_flow_imp.id(66219133941352153)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66219881373352153)
,p_plugin_attribute_id=>wwv_flow_imp.id(66219133941352153)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66220288632352154)
,p_plugin_attribute_id=>wwv_flow_imp.id(66219133941352153)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66220656215352154)
,p_plugin_id=>wwv_flow_imp.id(66210075089352148)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66221002967352154)
,p_plugin_attribute_id=>wwv_flow_imp.id(66220656215352154)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66221337118352154)
,p_plugin_attribute_id=>wwv_flow_imp.id(66220656215352154)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66221732866352154)
,p_plugin_attribute_id=>wwv_flow_imp.id(66220656215352154)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66222142296352155)
,p_plugin_attribute_id=>wwv_flow_imp.id(66220656215352154)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66222575632352155)
,p_plugin_attribute_id=>wwv_flow_imp.id(66220656215352154)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66222936837352155)
,p_plugin_id=>wwv_flow_imp.id(66210075089352148)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(66223281602352155)
,p_plugin_attribute_id=>wwv_flow_imp.id(66222936837352155)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(66223688717352155)
,p_plugin_id=>wwv_flow_imp.id(66210075089352148)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1866431486164382425)
,p_plugin_id=>wwv_flow_imp.id(66210075089352148)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
