...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66094725433351947)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66095101447351947)
,p_plug_template_id=>wwv_flow_imp.id(66094725433351947)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66095398757351947)
,p_plug_template_id=>wwv_flow_imp.id(66094725433351947)
,p_name=>'Tabs'
