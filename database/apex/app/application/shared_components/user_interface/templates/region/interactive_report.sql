...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66075168128351937)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66075497150351938)
,p_plug_template_id=>wwv_flow_imp.id(66075168128351937)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66075777757351938)
,p_plug_template_id=>wwv_flow_imp.id(66075168128351937)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66076094892351938)
,p_plug_template_id=>wwv_flow_imp.id(66075168128351937)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66076360832351938)
,p_plug_template_id=>wwv_flow_imp.id(66075168128351937)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66076673894351938)
,p_plug_template_id=>wwv_flow_imp.id(66075168128351937)
,p_name=>'Sub Regions'
