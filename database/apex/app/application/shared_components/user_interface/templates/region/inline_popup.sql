...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66069734087351934)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66070046172351935)
,p_plug_template_id=>wwv_flow_imp.id(66069734087351934)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66070390421351935)
,p_plug_template_id=>wwv_flow_imp.id(66069734087351934)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66070694177351935)
,p_plug_template_id=>wwv_flow_imp.id(66069734087351934)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66070919759351935)
,p_plug_template_id=>wwv_flow_imp.id(66069734087351934)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66071261907351935)
,p_plug_template_id=>wwv_flow_imp.id(66069734087351934)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66071537572351935)
,p_plug_template_id=>wwv_flow_imp.id(66069734087351934)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66071827701351935)
,p_plug_template_id=>wwv_flow_imp.id(66069734087351934)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66072197934351935)
,p_plug_template_id=>wwv_flow_imp.id(66069734087351934)
,p_name=>'Sub Regions'
