...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66102471867351951)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66102756724351951)
,p_plug_template_id=>wwv_flow_imp.id(66102471867351951)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66103040905351951)
,p_plug_template_id=>wwv_flow_imp.id(66102471867351951)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66103347157351951)
,p_plug_template_id=>wwv_flow_imp.id(66102471867351951)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66103680372351951)
,p_plug_template_id=>wwv_flow_imp.id(66102471867351951)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66103992872351951)
,p_plug_template_id=>wwv_flow_imp.id(66102471867351951)
