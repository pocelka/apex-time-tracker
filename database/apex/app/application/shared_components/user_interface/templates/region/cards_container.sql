...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66025476376351911)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66025766722351911)
,p_plug_template_id=>wwv_flow_imp.id(66025476376351911)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66026044800351911)
,p_plug_template_id=>wwv_flow_imp.id(66025476376351911)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66026391914351911)
,p_plug_template_id=>wwv_flow_imp.id(66025476376351911)
,p_name=>'Sub Regions'
