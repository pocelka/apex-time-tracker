...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66060602868351930)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66060885298351930)
,p_plug_template_id=>wwv_flow_imp.id(66060602868351930)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66061162611351930)
,p_plug_template_id=>wwv_flow_imp.id(66060602868351930)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66061419015351930)
,p_plug_template_id=>wwv_flow_imp.id(66060602868351930)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66061797469351930)
,p_plug_template_id=>wwv_flow_imp.id(66060602868351930)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66062029809351930)
,p_plug_template_id=>wwv_flow_imp.id(66060602868351930)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66062405884351931)
,p_plug_template_id=>wwv_flow_imp.id(66060602868351930)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66062701055351931)
,p_plug_template_id=>wwv_flow_imp.id(66060602868351930)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66062965746351931)
,p_plug_template_id=>wwv_flow_imp.id(66060602868351930)
,p_name=>'Sub Regions'
