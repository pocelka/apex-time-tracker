...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66082225563351941)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66082552662351942)
,p_plug_template_id=>wwv_flow_imp.id(66082225563351941)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66082864385351942)
,p_plug_template_id=>wwv_flow_imp.id(66082225563351941)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66083149033351942)
,p_plug_template_id=>wwv_flow_imp.id(66082225563351941)
,p_name=>'Sub Regions'
