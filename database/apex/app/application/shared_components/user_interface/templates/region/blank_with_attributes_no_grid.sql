...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66019770541351907)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66020043242351908)
,p_plug_template_id=>wwv_flow_imp.id(66019770541351907)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66020403719351908)
,p_plug_template_id=>wwv_flow_imp.id(66019770541351907)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66020617927351908)
,p_plug_template_id=>wwv_flow_imp.id(66019770541351907)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66020931522351908)
,p_plug_template_id=>wwv_flow_imp.id(66019770541351907)
,p_name=>'Sub Regions'
