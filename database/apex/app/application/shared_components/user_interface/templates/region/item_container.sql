...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66077249247351939)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66077550243351939)
,p_plug_template_id=>wwv_flow_imp.id(66077249247351939)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66077897085351939)
,p_plug_template_id=>wwv_flow_imp.id(66077249247351939)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66078181621351939)
,p_plug_template_id=>wwv_flow_imp.id(66077249247351939)
,p_name=>'Button Start'
