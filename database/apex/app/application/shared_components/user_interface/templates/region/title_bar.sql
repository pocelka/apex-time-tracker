...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66097394038351948)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66097689042351949)
,p_plug_template_id=>wwv_flow_imp.id(66097394038351948)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66097925391351949)
,p_plug_template_id=>wwv_flow_imp.id(66097394038351948)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66098238159351949)
,p_plug_template_id=>wwv_flow_imp.id(66097394038351948)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66098523708351949)
,p_plug_template_id=>wwv_flow_imp.id(66097394038351948)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66098830176351949)
,p_plug_template_id=>wwv_flow_imp.id(66097394038351948)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66099150990351949)
,p_plug_template_id=>wwv_flow_imp.id(66097394038351948)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66099450449351949)
,p_plug_template_id=>wwv_flow_imp.id(66097394038351948)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66099772400351949)
,p_plug_template_id=>wwv_flow_imp.id(66097394038351948)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66100031162351950)
,p_plug_template_id=>wwv_flow_imp.id(66097394038351948)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66100324003351950)
,p_plug_template_id=>wwv_flow_imp.id(66097394038351948)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66100612577351950)
,p_plug_template_id=>wwv_flow_imp.id(66097394038351948)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66101001732351950)
,p_plug_template_id=>wwv_flow_imp.id(66097394038351948)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66101231402351950)
,p_plug_template_id=>wwv_flow_imp.id(66097394038351948)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
