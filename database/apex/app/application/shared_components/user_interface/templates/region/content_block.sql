...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66047012589351923)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66047353934351923)
,p_plug_template_id=>wwv_flow_imp.id(66047012589351923)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66047680635351923)
,p_plug_template_id=>wwv_flow_imp.id(66047012589351923)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66047993275351923)
,p_plug_template_id=>wwv_flow_imp.id(66047012589351923)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66048266836351923)
,p_plug_template_id=>wwv_flow_imp.id(66047012589351923)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66048511523351923)
,p_plug_template_id=>wwv_flow_imp.id(66047012589351923)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66048850420351923)
,p_plug_template_id=>wwv_flow_imp.id(66047012589351923)
,p_name=>'Sub Regions'
