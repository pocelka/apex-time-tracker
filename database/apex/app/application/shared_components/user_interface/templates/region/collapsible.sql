...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66037240975351918)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66037559313351918)
,p_plug_template_id=>wwv_flow_imp.id(66037240975351918)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66037885793351918)
,p_plug_template_id=>wwv_flow_imp.id(66037240975351918)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66038145725351919)
,p_plug_template_id=>wwv_flow_imp.id(66037240975351918)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66038490579351919)
,p_plug_template_id=>wwv_flow_imp.id(66037240975351918)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66038792999351919)
,p_plug_template_id=>wwv_flow_imp.id(66037240975351918)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66039014927351919)
,p_plug_template_id=>wwv_flow_imp.id(66037240975351918)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66039335367351919)
,p_plug_template_id=>wwv_flow_imp.id(66037240975351918)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66039670482351919)
,p_plug_template_id=>wwv_flow_imp.id(66037240975351918)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66039991326351919)
,p_plug_template_id=>wwv_flow_imp.id(66037240975351918)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66040246742351919)
,p_plug_template_id=>wwv_flow_imp.id(66037240975351918)
,p_name=>'Sub Regions'
