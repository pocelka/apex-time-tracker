...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66065180614351932)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66065480867351932)
,p_plug_template_id=>wwv_flow_imp.id(66065180614351932)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66065752602351933)
,p_plug_template_id=>wwv_flow_imp.id(66065180614351932)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66066014979351933)
,p_plug_template_id=>wwv_flow_imp.id(66065180614351932)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66066320565351933)
,p_plug_template_id=>wwv_flow_imp.id(66065180614351932)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66066637710351933)
,p_plug_template_id=>wwv_flow_imp.id(66065180614351932)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66066974845351933)
,p_plug_template_id=>wwv_flow_imp.id(66065180614351932)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66067216903351933)
,p_plug_template_id=>wwv_flow_imp.id(66065180614351932)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66067566522351933)
,p_plug_template_id=>wwv_flow_imp.id(66065180614351932)
,p_name=>'Sub Regions'
