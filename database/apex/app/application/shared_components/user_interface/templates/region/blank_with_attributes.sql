...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66018380594351907)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66018650907351907)
,p_plug_template_id=>wwv_flow_imp.id(66018380594351907)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66018954650351907)
,p_plug_template_id=>wwv_flow_imp.id(66018380594351907)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66019229114351907)
,p_plug_template_id=>wwv_flow_imp.id(66018380594351907)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66019578390351907)
,p_plug_template_id=>wwv_flow_imp.id(66018380594351907)
,p_name=>'Sub Regions'
