...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66079741371351940)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66080047190351940)
,p_plug_template_id=>wwv_flow_imp.id(66079741371351940)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66080354957351940)
,p_plug_template_id=>wwv_flow_imp.id(66079741371351940)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66080626076351941)
,p_plug_template_id=>wwv_flow_imp.id(66079741371351940)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66080972047351941)
,p_plug_template_id=>wwv_flow_imp.id(66079741371351940)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66081289821351941)
,p_plug_template_id=>wwv_flow_imp.id(66079741371351940)
,p_name=>'Sub Regions'
