...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(66051665588351925)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66051922431351926)
,p_plug_template_id=>wwv_flow_imp.id(66051665588351925)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66052290301351926)
,p_plug_template_id=>wwv_flow_imp.id(66051665588351925)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66052519127351926)
,p_plug_template_id=>wwv_flow_imp.id(66051665588351925)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66052842473351926)
,p_plug_template_id=>wwv_flow_imp.id(66051665588351925)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(66053125011351926)
,p_plug_template_id=>wwv_flow_imp.id(66051665588351925)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
