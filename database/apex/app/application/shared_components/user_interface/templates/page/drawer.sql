...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(65982480558351838)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(65982745808351858)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(65983105332351859)
,p_page_template_id=>wwv_flow_imp.id(65982480558351838)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(65983329597351859)
,p_page_template_id=>wwv_flow_imp.id(65982480558351838)
